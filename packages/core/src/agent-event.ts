import { z } from "zod";
import { errorEntrySchema, messageEntrySchema, messagePartSchema } from "./history";
...
export const errorSchema = z.object({ type: z.literal("error"), error: errorEntrySchema });
